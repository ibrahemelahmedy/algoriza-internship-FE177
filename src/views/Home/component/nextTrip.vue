...
<template>
	<section class="flex flex-col my-[50px]">
		<div class="start-msg sm:w-3/5 mb-5">
			<h2 class="sm:text-2xl text-center sm:text-start font-semibold mb-4"
				>Get inspiration for your next trip</h2
			>
		</div>
		<div class="packages">
			<ul class="flex sm:flex-row flex-col gap-4">
				<li>
					<div class="package relative">
						<img
							class="mb-3 h[124px]"
							src="/src/assets/img/home/nextTrip/1.png"
							alt="1" />
						<div
							class="details text-center lg:text-start lg:text-white lg:absolute lg:bottom-5 lg:left-3 w-[90%]">
							<p class="lg:text-lg font-medium my-1 cursor-pointer"
				...
				<li>
					<div class="package relative">
						<img
							class="mb-3"
							src="/src/assets/img/home/nextTrip/2.png"
							alt="" />
						<div
							class="details text-center lg:text-start lg:text-white lg:absolute lg:bottom-5 lg:left-3 w-[90%]">
							<p class="lg:text-lg font-medium my-1 cursor-pointer"
				...
				<li>
					<div class="package relative">
						<img
							class="mb-3 max-h-[124px] lg:max-h-full"
							src="/src/assets/img/home/nextTrip/3.png"
							alt="" />
						<div
							class="details text-center lg:text-start lg:text-white lg:absolute lg:bottom-5 lg:left-3 w-[90%]">
							<p class="lg:text-lg font-medium my-1 cursor-pointer"
